...
export const TICKET_LIFECYCLE: TransitionDefinition[] = [
  ...
  { from: 'PENDING_APPROVAL', to: 'OFFER_MADE', allowedRoles: ['MANAGER', 'OWNER', 'ADMIN'] },
  ...
  { from: 'ACTIVE', to: 'REDEEMED', allowedRoles: ['CASHIER_TELLER', 'MANAGER', 'OWNER', 'ADMIN'] },
  { from: 'ACTIVE', to: 'OVERDUE' },
  { from: 'OVERDUE', to: 'GRACE_PERIOD', allowedRoles: ['MANAGER', 'OWNER'] },
  { from: 'GRACE_PERIOD', to: 'REDEEMED', allowedRoles: ['CASHIER_TELLER', 'MANAGER', 'OWNER', 'ADMIN'] },
