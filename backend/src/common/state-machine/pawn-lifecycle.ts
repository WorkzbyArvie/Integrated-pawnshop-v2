...
export const TICKET_LIFECYCLE: TransitionDefinition[] = [
  ...
  { from: 'REDEMPTION_PENDING_APPROVAL', to: 'REDEEMED', allowedRoles: ['MANAGER', 'OWNER', 'ADMIN'] },
  { from: 'REDEMPTION_PENDING_APPROVAL', to: 'ACTIVE', allowedRoles: ['MANAGER', 'OWNER', 'ADMIN'] },
