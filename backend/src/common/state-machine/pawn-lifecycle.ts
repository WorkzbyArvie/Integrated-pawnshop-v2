...
export const TICKET_LIFECYCLE: TransitionDefinition[] = [
  ...
  { from: 'PENDING_APPROVAL', to: 'OFFER_MADE', allowedRoles: ['MANAGER', 'OWNER', 'ADMIN', 'APPROVER'] },
  { from: 'PENDING_APPROVAL', to: 'CANCELLED', allowedRoles: ['MANAGER', 'OWNER', 'APPROVER'] },
  ...
  { from: 'ACTIVE', to: 'REDEMPTION_PENDING_APPROVAL', allowedRoles: ['CASHIER_TELLER', 'MANAGER', 'OWNER', 'ADMIN'] },
  ...
  { from: 'GRACE_PERIOD', to: 'REDEMPTION_PENDING_APPROVAL', allowedRoles: ['CASHIER_TELLER', 'MANAGER', 'OWNER', 'ADMIN'] },
  { from: 'REDEMPTION_PENDING_APPROVAL', to: 'REDEEMED', allowedRoles: ['MANAGER', 'OWNER', 'ADMIN', 'APPROVER'] },
  { from: 'REDEMPTION_PENDING_APPROVAL', to: 'ACTIVE', allowedRoles: ['MANAGER', 'OWNER', 'ADMIN', 'APPROVER'] },
  { from: 'REDEMPTION_PENDING_APPROVAL', to: 'GRACE_PERIOD', allowedRoles: ['MANAGER', 'OWNER', 'ADMIN'] },
